...
export const projects: Project[] = [
  ...
  },
  {
    ...
    summary:
      "Developed responsive templates, pages, and components for a new enterprise site that included a gated section supporting multiple audiences.",
    tech: ["HTML", "CSS", "JavaScript", ".NET Core"],
    role:
  ...
  },
  {
    ...
    tech: ["HTML", "CSS", "SASS", "JavaScript", "C#"],
    role:
